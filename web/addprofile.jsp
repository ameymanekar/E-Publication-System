...
.enjoy-css2 {
  ...
  transform: rotateX(-0.5729577951308232deg) rotateY(0.5729577951308231deg)   ;
   ...
   <body>         
<center>
  <div class="enjoy-css2"> View E-Paper </div>
<table style="width:100%" cellpadding="50px" cellspacing="50px" >
<form action="viewpaper1.jsp">
  <tr><td>  <input type="submit"class="enjoy-css" value="Flame"  /></td>
    
</form>
<form action="viewpaper2.jsp">
    <td><input type="submit"class="enjoy-css" value="IQAC Bulletin" /></td>
    
</form>
<form action="viewpaper3.jsp">
    <td><input type="submit"class="enjoy-css" value="Jyotirmay"  /></td>
